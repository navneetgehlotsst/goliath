         ...
         <table role="presentation" border="0" width="100%" cellspacing="0" style="margin-top: 20px;">
            <tr>
               <td bgcolor="#1e532e" align="center" style="background-image: url('{{asset('web/assets/images/new-img/hero-banner.jpg')}}'); color: white; height: 100px; padding: 20px 0px;">
                  <h2 style="font-family: poppins; margin-top: 20px;">Welcome to <br> Goliath Registration!</h2>
            </tr>
            </td>
         </table>
         <!-- Body 1 -->
         <table role="presentation" border="0" width="100%" cellspacing="0">
            <tr>
               <td style="padding: 30px 30px 30px 30px;">
                  ...
                  <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:poppins">Wow! Thanks for registering an account With Goliath!</b></p>
         ...
         <table role="presentation" border="0" width="100%">
            <tr>
               <td align="center" style="padding: 30px 30px;">
                <p style="text-align:center; font-family: poppins; font-size: 14px; font-weight: 400;">Copyright © 2024 <a href="" target="_blank" style="color: #1BADC4; font-weight: 600;">Goliath</a> All rights reserved.</p>
               </td>
            </tr>
         </table>
         <!-- Footer -->
