...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <h5 class="py-3 mb-4">
        <span class="text-muted fw-light"><a href="{{route('admin.dashboard')}}">Home</a> / <a href="{{route('admin.users.index')}}">Users </a> / <a href="{{ route("admin.users.show", $userid) }}">User Detail /</a></span> Match Information
    </h5>
    <div class="row mb-5">
